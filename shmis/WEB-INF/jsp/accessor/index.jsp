...
<head>
    ...
    <!-- 添加ExtJs 3.4 javascript debug locale -->
    <script type="text/javascript" src="${ctx}/js/ext3/ext-all-debug.js"></script>
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="${ctx}/background/accessor/login"><i class="icon-font">&#xe008;</i>用户登录</a></li>

...
var MyViewport1=new Ext.Viewport({
	...
	items:[
		...
		html: '<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed;">'+
			  '<tr><td width="254px" style="background:url(/shmis/images/top_left.jpg)">&nbsp;</td>'+
// 			  '<td style="background:#BFFAE6">&nbsp;</td>'+
// 			  '<td width="544px" style="background:url(/shmis/images/top_right.jpg)"><div id="clock" class="clock"></div></td>'+
			  '</tr>'+
			'</table>',
            	margins: '5 5 5 5'
		},
...
Ext.Ajax.request({
	url : '/shmis/background/menu',
// 	url:'/shmis/background/menumanager/data',

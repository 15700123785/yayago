...
<title>房管局后台管理系统</title>

<link rel="stylesheet" type="text/css" href="${ctx}/css/ext-all.css" />
<link rel="stylesheet" type="text/css"
	href="${ctx}/css/ux/CenterLayout.css" />
<link rel="stylesheet" type="text/css"
	href="${ctx}/css/layout-browser/layout-browser.css" />
...
<!-- extensions -->
<script type="text/javascript" src="${ctx}/js/ext3/ux/CenterLayout.js"></script>
<script type="text/javascript" src="${ctx}/js/ext3/ux/RowLayout.js"></script>
<script type="text/javascript" src="${ctx}/js/ext3/layouts/basic.js"></script>
<script type="text/javascript" src="${ctx}/js/ext3/layouts/custom.js"></script>
<script type="text/javascript" src="${ctx}/js/ext3/layouts/combination.js"></script>
<script type="text/javascript" src="${ctx}/js/ext3/layouts/layout-browser.js"></script>


</head>
<body>
  <div id="header"><h1>房管局后台管理系统</h1></div>
    <div style="display:none;">

        <!-- Start page content -->
        <div id="start-div">
            <div style="float:left;" ><img src="${ctx}/images/layout-icon.gif" /></div>

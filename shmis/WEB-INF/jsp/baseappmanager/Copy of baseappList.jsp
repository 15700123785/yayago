...
Ext.onReady(function(){
	...
	Ext.onReady(function(){
		 gridstore = new Ext.data.JsonStore( {
				...
				idProperty : 'id',
				fields : [ 'id','selfServers','zzjid','printName','printName_xp','page_height','syImg',
				  'txmImg','password','times','gnID','is_ceshi','dzyz','fwsl',
				  'isoPenXP','xp_port','xp_txt1','xp_txt2','xp_txt4','xp_txt5','saveLog','marquee_txt','dzyz_left',
				  'dzyz_top','defaultPages','print_show','print_SystemName','dwmc','backTime','remark2','remark1',
				  'remark11','print_fun_id','closeThread','shutdownCode','sm','sxt','systemName','allArea',
				  'area','curentArea','debug','delete_Img','hqserv','idport','openCard','paperCount'],

...
//    html+="~@~房改信息~|~3~|~170~|~160~|~房改信息~|~FGXX.jpg~|~1";
...
function BindList(val,len)
{
    ...
    for (var i=0;i<strs.length;i++)
    {
         ...
         var obj = $("<div style=\"cursor:pointer;\" onclick=\"gn_click('"+str[0]+"','"+str[1]+"')\" id=\"div"+i+"\"><div style=\"text-align:center;margin-top:"+(height-30)+";color:White;font-family:微软雅黑;\">"+str[0]+"</div></div>").appendTo("body");
